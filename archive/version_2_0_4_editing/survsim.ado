*! version 2.0.4 01oct2014 MJC

/*
History
MJC 01oct2014 version 2.0.4 - undocumented enter() now only changes lower limit of quadrature (used to change lower limit of root finding as well)
							- cumhaz0 removed from logcumhaz/cumhaz
...
program define survsim
	...
	syntax newvarname(min=1 max=2), 										///
									...
									/* User-defined */						///
										...
										MINTime(string)						///	-lower limit for Brents method-
										ENTER(varname)						///	-lower limit for quadrature-
									]
